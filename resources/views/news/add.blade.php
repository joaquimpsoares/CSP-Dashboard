        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <p class="text-muted font-weight-light">
                    {{ ucwords(trans_choice('messages.add_announcements', 1)) }}
                </p>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <x-input type="text" id="title" name="title" placeholder="Title" value=""/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="flex-1 block w-full min-w-0 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id="description" name="description" placeholder="@lang('app.postal_code')" value=""> </textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <x-input type="file" id="postal_code" name="image" placeholder="@lang('app.postal_code')" value=""/>
                </div>
                <div class="form-group">
                    ...
                    <div class="mt-2">
                        <div>
                            <x-label class="inline-flex items-center">
                                <input name="provider" type="checkbox" class="form-checkbox" checked>
                                <span class="ml-2">{{ ucwords(trans_choice('messages.provider', 1)) }}</span>
                            </x-label>
                        </div>
                        <div>
                            <x-label class="inline-flex items-center">
                                <input name="reseller" type="checkbox" class="form-checkbox">
                                <span class="ml-2">{{ ucwords(trans_choice('messages.reseller', 1)) }}</span>
                            </x-label>
                        </div>
                        <div>
                            <x-label class="inline-flex items-center">
                                <input name="customer" type="checkbox" class="form-checkbox">
