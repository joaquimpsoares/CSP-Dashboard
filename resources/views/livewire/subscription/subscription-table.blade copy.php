                                                                ...
                                                                <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <td></td>
                                                                            @if ($subscription->billing_type != 'software')
                                                                            @foreach ($subscription->products->first()->getaddons()->all() as $key => $item)
                                                                            <tr>
                                                                                <div wire:key="{{ $key }}">
                                                                                    <td class="px-2 py-2 text-sm text-gray-500 whitespace-wrap"><strong>Add-on:</strong> {{$item->name}}</td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="w-24 pt-0 mb-3">
                                                                                            <button type="button"class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-gray-800 border border-transparent rounded-md hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25" wire:click.prevent="addAddon('{{$item->id}}', '{{$subscription->id}}', '{{$quantity}}')">
                                                                                                Change
                                                                                            </button>
                                                                                        </div>
                                                                                    </td>
