        ...
        <div @if(!$subscription->productonce->IsNCE() && !$subscription->product->IsPerpetual()) wire:init="validateisEligible({{ $subscription->id }})" @endif>
            <div class="relative z-0 flex-col flex-1 overflow-y-auto">
                ...
                <div class="mb-4 overflow-hidden bg-white shadow sm:rounded-lg">
                    ...
                    <div class="px-4 py-3 border-t border-gray-200 sm:px-6">
                        <div class="ml-6">
                            <div class="mt-4 mb-8"><ol class="relative border-l border-gray-200">
                                @if($subscription->IsMigrated())
                                ...
                                <li class="mb-10 ml-6">
                                    ...
                                    <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900">{{$subscription->name}}
                                    ...
                                    <time class="block mb-2 text-xs font-normal leading-none text-gray-400">{{$item->created_at}}</time>
                                    <p class="mb-2 text-sm text-base font-normal text-gray-500">{{$item->details}}</p>
                                </li>
                                @endforeach
                                @endif
                                ...
                                <li class="mb-10 ml-6">
                                    ...
                                    <h3 class="flex items-center mb-1 text-sm font-medium font-semibold text-gray-900">
                                        {{$subscription->name}}
                                        <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded ml-3">
                                            {{ ucwords(trans_choice($item->status->name, 1)) }}
                                        </span>
