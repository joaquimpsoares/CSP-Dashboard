                    ...
                    <div class="w-auto p-0 m-0">
                        ...
                        <div class="box-border focus:border-transparent">
                            <div style="display:flex" class="box-border flex leading-5 focus:border-transparent">
                                ...
                                <button @if($autorenew == false) disabled @endif wire:click="migrateToMCE({{$subscription->id}})" class="{{ $autorenew == false ? 'text-gray-400 cursor-not-allowed' : 'bg-yellow-100 text-black-800'  }} box-border relative inline-block max-w-full py-2 m-0 mt-1 overflow-hidden font-semibold leading-none text-center whitespace-no-wrap align-middle bg-white border-2 border-transparent border-solid rounded-sm disabled:cursor-not-allowed disabled:opacity-75 focus:bg-black focus:border-white hover:bg-black hover:border-white">
                                    Change renewall
                                </button>
                            </div>
                        </div>
                        {{-- <input type="text" value="tbone"  class="block w-full px-3 py-2 mt-1 text-sm bg-white border rounded-md shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500 "/>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        @endif
                                        @endif
                                        <x-input wire:model="editing.amount" type="number" id="editing.amount" class="@error('editing.amount') is-invalid @enderror"></x-input>
