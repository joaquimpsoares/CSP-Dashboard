                ...
                <div class="px-4 py-5 bg-white border-b border-gray-200 sm:px-6">
                    <div class="flex flex-wrap items-center justify-between -mt-4 -ml-4 sm:flex-nowrap">
                        ...
                        <div class="flex flex-shrink-0 mt-4 ml-4">
                            ...
                            <input type="button"  wire:model="taskduedate" class="relative inline-flex items-center px-4 py-2 ml-5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm marginr-3 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                            placeholder="Select date" autocomplete="off" id="daterange-btn"
