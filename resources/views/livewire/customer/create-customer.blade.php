            ...
            <section class="dark-grey-text">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <x-input wire:model="address_1" type="text" id="address_1" name="address_1" mb-4 class="@error('address_1') is-invalid @enderror" value="{{ old('address_1') }}" placeholder="1234 Main St"></x-input>
                                        ...
                                        <x-input wire:model="address_2" type="text" id="address_2" name="address_2" mb-4 class="@error('address_2') is-invalid @enderror" value="{{ old('address_2') }}" placeholder="Appartment or numer"></x-input>
                                        ...
                                        <div class="row">
                                            <div class="mb-4 col-lg-4 col-md-6">
                                                ...
                                                <x-input wire:model="city" type="text" id="city" name="city" mb-4 class="@error('city') is-invalid @enderror" value="{{ old('city') }}"></x-input>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select wire:model="status" name="status" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md @error('status') is-invalid @enderror" sf-validate="required">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <x-input wire:model="socialite_id" type="text" name="socialite_id"   class="@error('socialite_id') is-invalid @enderror" id='socialite_id'  value="{{ old('socialite_id') }}"></x-input>
                ...
                <div class="card">
                    ...
                    <div class="px-4 py-3  text-right sm:px-6">
                        <x-button type="submit">{{ucwords(trans_choice('messages.create', 1))}}</x-button>
                    </div>
                </div>
            </section>
        </div>
