                        ...
                        <div class="py-6">
                            ...
                            <x-bladewind.tab-group name="settings">
                                <x-slot name="headings">
                                    ...
                                    name="userprofile" active="true" label="User Profile" />
                                    <x-bladewind.tab-heading
                                    name="unsplash-2" label="Account" />
                                    <x-bladewind.tab-heading
                                    name="unsplash-3" label="Notifications" />
                                    <x-bladewind.tab-heading
                                    name="unsplash-4" label="Security" />
                                    <x-bladewind.tab-heading
                                                        ...
                                                        <div class="px-4 py-6 bg-white sm:p-6">
                                                            ...
                                                            <div class="grid grid-cols-4 gap-6 mt-6">
                                                                ...
                                                                <div class="col-span-4 sm:col-span-1">
                                                                    <label for="expiration-date" class="block text-sm font-medium text-gray-700">Address</label>
                                                                    <input wire:model.debounce.500ms="editing.address" type="text" name="expiration-date" id="expiration-date" autocomplete="cc-exp" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm" placeholder="MM / YY">
                                                                </div>

                                                                <div class="col-span-4 sm:col-span-1">
                                                                    <label for="expiration-date" class="block text-sm font-medium text-gray-700">City</label>
                                                                    <input wire:model.debounce.500ms="editing.city" type="text" name="expiration-date" id="expiration-date" autocomplete="cc-exp" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm" placeholder="MM / YY">
                                                                </div>
                                                                <div class="col-span-4 sm:col-span-2">
                                                                ...
                                                                <div class="col-span-4 sm:col-span-1">
                                                                    ...
                                                                    <input wire:model.debounce.500ms="editing.postal_code" type="text" name="expiration-date" id="expiration-date" autocomplete="cc-exp" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm" placeholder="MM / YY">
                                                                </div>
                                                                ...
                                                                <div class="col-span-4 sm:col-span-2">
                                                                    <label for="postal-code" class="block text-sm font-medium text-gray-700">Phone</label>
                                                                    <input wire:model.debounce.500ms="editing.phone" type="text" name="postal-code" id="postal-code" autocomplete="postal-code" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm">
                                                                </div>
                                                            </div>
                                                        </div>
