            ...
            <div class="flex flex-1 xl:overflow-hidden">
                ...
                <nav aria-label="Sections" class="flex-shrink-0 hidden bg-white border-r w-96 border-blue-gray-200 xl:flex xl:flex-col">
                    ...
                    <div class="flex-1 min-h-0 overflow-y-auto">
                        ...
                        <a href="#" class="flex p-6 bg-opacity-50 border-b bg-blue-50 border-blue-gray-200" aria-current="page">
                            <!-- Heroicon name: outline/cog -->
                            <svg class="flex-shrink-0 -mt-0.5 h-6 w-6 text-blue-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                        ...
                        <a href="#" class="flex p-6 border-b hover:bg-blue-50 hover:bg-opacity-50 border-blue-gray-200">
                        ...
                        <form class="mt-6 space-y-8 divide-y divide-y-blue-gray-200">
                            <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="block w-full mt-1 rounded-md shadow-sm border-blue-gray-300 text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>

                                <div class="sm:col-span-3">
                                    <label for="last-name" class="block text-sm font-medium text-blue-gray-900"> Last name </label>
                                    <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full mt-1 rounded-md shadow-sm border-blue-gray-300 text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>

                                <div class="sm:col-span-6">
                                    <label for="username" class="block text-sm font-medium text-blue-gray-900"> Username </label>
                                    <div class="flex mt-1 rounded-md shadow-sm">
                                        <span class="inline-flex items-center px-3 border border-r-0 rounded-l-md border-blue-gray-300 bg-blue-gray-50 text-blue-gray-500 sm:text-sm"> workcation.com/ </span>
                                        <input type="text" name="username" id="username" autocomplete="username" value="lisamarie" class="flex-1 block w-full min-w-0 rounded-none border-blue-gray-300 rounded-r-md text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <textarea id="description" name="description" rows="4" class="block w-full border rounded-md shadow-sm border-blue-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500"></textarea>
                                    </div>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <input type="text" name="url" id="url" class="block w-full mt-1 rounded-md shadow-sm border-blue-gray-300 text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 pt-8 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <input type="text" name="email-address" id="email-address" autocomplete="email" class="block w-full mt-1 rounded-md shadow-sm border-blue-gray-300 text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>

                                <div class="sm:col-span-3">
                                    <label for="phone-number" class="block text-sm font-medium text-blue-gray-900"> Phone number </label>
                                    <input type="text" name="phone-number" id="phone-number" autocomplete="tel" class="block w-full mt-1 rounded-md shadow-sm border-blue-gray-300 text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <input type="text" name="language" id="language" class="block w-full mt-1 rounded-md shadow-sm border-blue-gray-300 text-blue-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            ...
                            <div class="flex justify-end pt-8">
                                <button type="button" class="px-4 py-2 text-sm font-medium bg-white border border-gray-300 rounded-md shadow-sm text-blue-gray-900 hover:bg-blue-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Cancel</button>
                                <button type="submit" class="inline-flex justify-center px-4 py-2 ml-3 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
