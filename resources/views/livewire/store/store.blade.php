<div>
    ...
    <main class="px-4 mx-auto sm:px-6 lg:px-8"  x-data="{'layout': 'grid'}">
        ...
        <section aria-labelledby="products-heading" class="pt-6 pb-24">
                    ...
                    <div tabindex="0" class="focus:outline-none"  x-show="layout === 'grid'" x-cloak>
                        <div class="container py-2 mx-auto" >
                            <div class="flex flex-wrap items-center justify-center lg:justify-between">
                                ...
                                <div tabindex="{{$index}}" wire:click="showproductdetails({{ $price->related_product->id }})" class="mt-8 overflow-hidden transition duration-500 ease-in-out transform rounded-lg shadow-lg cursor-pointer hover:-translate-y-5 hover:shadow-2xl h-90 w-90 md:w-80">
                                    <div>
                                    ...
                                    <div class="bg-white">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="flex items-center justify-between py-4">
                                                ...
                                                <button tabindex="{{$index}}" class="p-2 text-white bg-blue-600 rounded-full hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
            ...
            <div x-data="{ open: true }" @keydown.window.escape="open = false">
                <div class="relative flex flex-col-reverse group">
                    ...
                    <div class="overflow-hidden bg-gray-100 rounded-lg aspect-w-4 aspect-h-3">
                        <img src="https://tailwindui.com/img/ecommerce-images/product-quick-preview-03-preview.jpg" alt="Light green canvas bag with black straps, handle, front zipper pouch, and drawstring top." class="object-cover object-center">
                        <div class="flex items-end p-4">
                            <button type="button" class="relative z-10 w-full px-4 py-2 text-sm text-gray-900 bg-white bg-opacity-75 rounded-md opacity-0 group-hover:opacity-100 focus:opacity-100" @click="open = true">Quick View<span class="sr-only">, Everyday Ruck Snack</span></button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="relative flex items-center w-full px-4 pb-8 overflow-hidden bg-white shadow-2xl pt-14 sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                                ...
                                <div class="grid items-start w-full grid-cols-1 gap-y-8 gap-x-6 sm:grid-cols-12 lg:gap-x-8">
                                    ...
                                    <div class="sm:col-span-8 lg:col-span-7">
                                        <h2 class="text-2xl font-extrabold text-gray-900 sm:pr-12">Everyday Ruck Snack</h2>
                                        ...
                                        <section aria-labelledby="information-heading" class="mt-4">
                                                ...
                                                <div class="pl-4 ml-4 border-l border-gray-300">
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="flex items-center">
                                                            ...
                                                            <svg class="flex-shrink-0 w-5 h-5 text-yellow-400" x-state:on="Active" x-state:off="Default" x-state-description="Active: &quot;text-yellow-400&quot;, Default: &quot;text-gray-300&quot;" x-description="Heroicon name: solid/star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                                            </svg>

                                                            <svg class="flex-shrink-0 w-5 h-5 text-yellow-400" x-state-description="undefined: &quot;text-yellow-400&quot;, undefined: &quot;text-gray-300&quot;" x-description="Heroicon name: solid/star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                                            </svg>
                                                            ...
                                                            <svg class="flex-shrink-0 w-5 h-5 text-gray-300" x-state-description="undefined: &quot;text-yellow-400&quot;, undefined: &quot;text-gray-300&quot;" x-description="Heroicon name: solid/star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                                            </svg>
                                            ...
                                            <div class="flex items-center mt-6">
                                                <svg class="flex-shrink-0 w-5 h-5 text-green-500" x-description="Heroicon name: solid/check" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            ...
                                            <form>
                                                <div class="sm:flex sm:justify-between">
                                                    ...
                                                    <fieldset x-data="window.Components.radioGroup({ initialCheckedIndex: 0 })" x-init="init()">
                                                        ...
                                                        <div class="grid grid-cols-1 gap-4 mt-1 sm:grid-cols-2">
                                                            ...
                                                            <label x-radio-group-option="" class="relative block p-4 border border-gray-300 rounded-lg cursor-pointer focus:outline-none undefined" x-description="Active: &quot;ring-2 ring-indigo-500&quot;" :class="{ 'ring-2 ring-indigo-500': (active === '18L'), 'undefined': !(active === '18L') }">
                                                                <input type="radio" x-model="value" name="size-choice" value="18L" class="sr-only" aria-labelledby="size-choice-0-label" aria-describedby="size-choice-0-description">
                                                                ...
                                                                <div class="absolute border-2 border-transparent rounded-lg pointer-events-none -inset-px" aria-hidden="true" x-description="Active: &quot;border&quot;, Not Active: &quot;border-2&quot;	Checked: &quot;border-indigo-500&quot;, Not Checked: &quot;border-transparent&quot;" :class="{ 'border': (active === '18L'), 'border-2': !(active === '18L'), 'border-indigo-500': (value === '18L'), 'border-transparent': !(value === '18L') }"></div>
                                                            </label>

                                                            <label x-radio-group-option="" class="relative block p-4 border border-gray-300 rounded-lg cursor-pointer focus:outline-none ring-2 ring-indigo-500" x-description="Active: &quot;ring-2 ring-indigo-500&quot;" :class="{ 'ring-2 ring-indigo-500': (active === '20L'), 'undefined': !(active === '20L') }">
                                                                <input type="radio" x-model="value" name="size-choice" value="20L" class="sr-only" aria-labelledby="size-choice-1-label" aria-describedby="size-choice-1-description">
                                                                ...
                                                                <div class="absolute border border-indigo-500 rounded-lg pointer-events-none -inset-px" aria-hidden="true" x-description="Active: &quot;border&quot;, Not Active: &quot;border-2&quot;	Checked: &quot;border-indigo-500&quot;, Not Checked: &quot;border-transparent&quot;" :class="{ 'border': (active === '20L'), 'border-2': !(active === '20L'), 'border-indigo-500': (value === '20L'), 'border-transparent': !(value === '20L') }"></div>
                                                            </label>
                                                ...
                                                <div class="flex mt-4">
                                                    <a href="#" class="flex text-sm text-gray-500 group hover:text-gray-700">
                                                        ...
                                                        <svg class="flex-shrink-0 w-5 h-5 ml-2 text-gray-400 group-hover:text-gray-500" x-description="Heroicon name: solid/question-mark-circle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path>
                                                        </svg>
                                                    </a>
                                                </div>
                                                <div class="mt-6">
                                                    <button type="submit" class="flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500">Add to bag</button>
                                                </div>
                                                <div class="mt-6 text-center">
                                                    <a href="#" class="inline-flex text-base font-medium group">
                                                        <svg class="flex-shrink-0 w-6 h-6 mr-2 text-gray-400 group-hover:text-gray-500" x-description="Heroicon name: outline/shield-check" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
