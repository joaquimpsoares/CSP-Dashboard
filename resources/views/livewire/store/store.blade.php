                                    ...
                                    <div class="px-4 py-4 sm:px-6">
                                        ...
                                        <div class="mt-0 sm:flex sm:justify-between">
                                            ...
                                            <div class="flex items-center mt-2 text-sm text-gray-500 sm:mt-0">
                                                ...
                                                <button wire:click="addToCartWithCustomer({{ $price->related_product->id }},'{{Auth::user()->customer->id}}', '{{ $price->id}})')" class="flex inline p-2 ml-auto text-white transition duration-300 bg-gray-800 rounded-full hover:bg-gray-500 hover:text-purple-900 hover:shadow-xl focus:outline-none">
