                    ...
                    <div class="relative flex-1 px-4 mt-6 sm:px-6">
                        ...
                        <div class="flex items-center px-6 py-2 -mx-8 hover:bg-gray-100">
                            ...
                            <div class="flex justify-center w-1/5">
                                ...
                                <input wire:change="changeQty($event.target.value, '{{$item->id}}')" wire:model="qty" value={{$item->qty}} name="qty" class=" @error('qty') is-invalid @enderror mx-2 text-sm text-center border rounded-sm w-14 focus:outline-none" type="text" >
