    ...
    <div x-data="{ resellerOpen: false , isOpen: false }" class="relative z-0 flex-col flex-1 overflow-y-auto">
        <div class="p-4 overflow-hidden bg-white">
            <div class="flex flex-col">
                ...
                <x-table :list="$orders" :mobileColumns="[
                    'company_name',
                    'subscriptions'
                    ]"
                :columns="[
                    ...
                    'company_name' => null,
                    'details' => null,
                    'orderproducts.quantity' => null,
                    'orderproducts.quantity*orderproducts.retail_price) * (orderproducts.billing_cycle === 'annual' ? 12 : 1 ) ' => null,
                    'created_at' => null
                ]"
                :listElementActions="[
                    [
