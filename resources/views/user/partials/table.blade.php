						...
						<div class="col-md-12">
							<div class="md-form">
								<div style="display: flex;">
									...
									<div>
										<a href="{{route('user.create', ['level' => 'provider', 'customer_id' => $customer->id] )}}" style = "font-color:fffff" class="btn submit_btn">new user</a>
									</div>
									@endif
									...
									@endif	@if (Auth::user()->hasRole('Reseller'))
									<div>
										<a href="{{route('user.create', ['level' => 'customer', 'customer_id' => $reseller->id] )}}" style = "font-color:fffff" class="btn submit_btn">new user</a>
									</div>
									@endif
								</div>
