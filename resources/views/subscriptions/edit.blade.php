...
<style>
    ...
    .wrapper{transform-style: preserve-3d;position:absolute;top:0;left:0;height:485px;width:360px;}
    .tile:hover{
    ...
    <div id="back">
        ...
        <form action="">
            ...
            <div class="short">
                ...
                <input type="text" value="{{$subscription->amount}}" />
            </div>
            <div class="short">
                <label>START DATE</label>
                <input type="text" value="{{$subscription->status->name}}" />
            </div>
