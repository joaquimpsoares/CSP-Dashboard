        ...
        <dl class="grid grid-cols-1 gap-5 mt-5 sm:grid-cols-2 lg:grid-cols-3">
            <div class="relative px-4 pt-5 pb-12 overflow-hidden bg-white rounded-lg shadow sm:pt-6 sm:px-6">
                <dt>
                    ...
                    <p class="ml-16 text-sm font-medium text-gray-500 truncate">{{ ucwords(trans_choice( 'messages.subscription', 2)) }}</p>
                </dt>
            ...
            <div class="relative px-4 pt-5 pb-12 overflow-hidden bg-white rounded-lg shadow sm:pt-6 sm:px-6">
                <dt>
                    ...
                    <p class="ml-16 text-sm font-medium text-gray-500 truncate">{{ ucwords(trans_choice( 'messages.about_to_expire', 2)) }}</p>
                </dt>
                <dd class="flex items-baseline pb-6 ml-16 sm:pb-7">
                    <p class="text-2xl font-semibold text-gray-900">
                        {{$abouttoexpire->count()}}
