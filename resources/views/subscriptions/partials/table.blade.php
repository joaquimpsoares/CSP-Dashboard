                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group custom-search-form">
                            <input type="text" class="form-control input-solid" name="search" value="{{ Request::get('search') }}" placeholder="@lang('Search for subscriptions...')">
                            <span class="input-group-append">
                                @if (Request::has('search') && Request::get('search') != '')
                                <a href="{{ route('subscription.index') }}" class="btn btn-light d-flex align-items-center text-muted" role="button">
                    ...
                    <div class="col">
                        <div class="input-group custom-search-form">
                            <input type="text" class="form-control input-solid" name="customer" value="{{ Request::get('customer') }}" placeholder="@lang('Search for customers name...')">
                            <span class="input-group-append">
