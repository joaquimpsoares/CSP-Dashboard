...
<dl class="grid grid-cols-1 gap-5 px-4 py-5 sm:p-6 sm:grid-cols-2 lg:grid-cols-3">
    <!-- Chatbox -->
    <div class="p-6 bg-white rounded-lg shadow chatbox">
        <div id="chatOutput" class="h-64 p-3 mb-4 overflow-y-auto bg-gray-100 rounded"></div>
        <form id="chatForm">
            <input type="text" id="chatInput" class="w-full p-2 border rounded" placeholder="Ask something...">
            <button type="submit" class="w-full px-4 py-2 mt-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700">
                Send
            </button>
        </form>
    </div>
    ...
    <div class="space-y-6 lg:col-start-1 lg:col-span-2">
        <section aria-labelledby="bignews-title">
            <div class="p-6 mb-10 bg-indigo-200 rounded-lg shadow">
                <div class="md:flex">
                    <div class="md:w-1/2">
                        <h2 class="mb-2 text-xl font-bold leading-tight text-gray-800 md:text-2xl">
                            Welcome {{Auth::user()->name}},
                        </h2>
                        <p class="mb-4 text-gray-700">
                            Great to have you here with us, {{Auth::user()->name}} we have setup for you this account so that you can manage your
                            customers and their subscriptions, you'll find here all that you need to make your life ease.
                        </p>
                        <p class="mb-4 text-gray-700">
...
<script>
    ...
    // If you want to prevent the default form submission:
