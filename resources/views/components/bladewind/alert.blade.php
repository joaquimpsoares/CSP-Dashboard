...
<div class="w-full bw-alert flex p-3 {{$color[$shade][$type]}} {{$color[$shade][$type.'_text']}} {{$class}}">
    ...
    @if($show_close_icon == 'true')
        <div class="text-right">
            <svg xmlns="http://www.w3.org/2000/svg" class="inline w-5 h-5 ml-3 cursor-pointer" viewBox="0 0 20 20" fill="currentColor" onclick="this.parentElement.parentElement.style.display='none'">
