@props([
    ...
    'sizes' => [
        ...
        'big' => 'px-4 py-2 text-sm',
        'large' => 'px-4 py-2 text-base',
        'xl' => 'px-6 py-3 border text-base',
...
@endphp
<button {{$button_function}} onclick="location.href='{{ url($url) }}'"
{{ $attributes->merge(['class' => "inline-flex items-center border border-transparent font-medium rounded shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500  $sizes[$size] $type $name $primary_color $is_disabled"]) }}
