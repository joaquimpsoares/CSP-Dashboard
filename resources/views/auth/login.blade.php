                ...
                <div class="mx-auto col">
                    <div class="row justify-content-center">
                        <div class="col-lg-9 col-xl-8">
                            <div class="mb-0 card-group">
                                <div class="p-4 card page-content">
                                    <div class="card-body page-single-content">
                                        ...
                                        <div class="py-5 mt-0 text-white card bg-primary d-md-down-none page-content">
                                            <div class="text-center card-body justify-content-center page-single-content">
