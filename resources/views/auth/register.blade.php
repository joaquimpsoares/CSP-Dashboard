                            ...
                            <form method="POST" action="{{ route('provider.create') }}">
                                ...
                                <div class="row">
                                    <div class="md-form col-md-6">
                                        <label for="company_name" class="col-md-4 col-form-label text-md-left">{{ __('Company Name') }}</label>
                                    ...
                                    <div class="md-form col-md-6">
                                        <label for="nif" class="col-md-4 col-form-label text-md-left">{{ __('NIF') }}</label>
