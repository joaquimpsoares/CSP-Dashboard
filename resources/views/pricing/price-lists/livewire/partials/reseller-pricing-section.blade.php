    ...
    <x-bladewind.card title="Pricing">
        @if($assignments->isEmpty())
            <p class="text-sm text-gray-500">
                No price list override assigned. The resolver will fall back to the
                <strong>provider default</strong>.
                Assign a default from the
        ...
        @else
            ...
            <p class="mt-3 text-xs text-gray-500">
                Manage assignments from the
                <a href="{{ route('pricing.price_lists.index') }}" class="text-indigo-600 underline hover:text-indigo-800">Price Lists</a>
                page — open a price list and use the Assignments tab.
            </p>
        @endif
    </x-bladewind.card>
</div>
