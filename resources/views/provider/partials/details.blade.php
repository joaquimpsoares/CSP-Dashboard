    ...
    <div class="card-body">
        <div class="col-lg-12">
                ...
                <div class="input-group mb-4">
                    ...
                    <input name="username" type="text" class="form-control py-0" aria-describedby="basic-addon1" value="{{$provider->nif}}" placeholder="Username (Optional)">
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <select name="status_id" class="form-select" sf-validate="required">
                                <option value="{{$provider->status->id}}" selected>{{$provider->status->name}}</option>
