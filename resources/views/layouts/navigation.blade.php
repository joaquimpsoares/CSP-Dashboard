        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden items-center gap-6 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="right" width="w-[720px]" contentClasses="p-4">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center gap-2 rounded-lg border border-transparent bg-transparent px-1 pt-1 text-sm font-medium leading-5 text-slate-600 hover:text-slate-900 focus:outline-none transition">
