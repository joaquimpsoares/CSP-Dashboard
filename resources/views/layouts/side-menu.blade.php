...
<div class="flex h-screen bg-gray-100" style="min-height: 640px;">
    ...
    <div class="flex flex-col flex-grow mt-5">
        <nav class="flex-1 px-2 space-y-1 bg-white" aria-label="Sidebar">
            <div>
                <a href="{{route('home')}}" class="flex items-center w-full py-2 pr-2 text-sm font-medium text-gray-900 rounded-md group pl-7" x-state:on="Current" x-state:off="Default" x-state-description="Current:"bg-gray-100 text-gray-900", Default:"bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900"">
            ...
            <div>
                <a href="{{ route('provider.index') }}" class="flex items-center w-full py-2 pr-2 text-sm font-medium text-gray-900 rounded-md group pl-7" x-state:on="Current" x-state:off="Default" x-state-description="Current:"bg-gray-100 text-gray-900", Default:"bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900"">
            ...
            <div>
                <a href="{{ route('reseller.index') }}" class="flex items-center w-full py-2 pr-2 text-sm font-medium text-gray-900 rounded-md group pl-7" x-state:on="Current" x-state:off="Default" x-state-description="Current:"bg-gray-100 text-gray-900", Default:"bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900"">
                    <svg class="w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div>
                <a href="{{ route('customer.index') }}" class="flex items-center w-full py-2 pr-2 text-sm font-medium text-gray-900 rounded-md group pl-7" x-state:on="Current" x-state:off="Default" x-state-description="Current:"bg-gray-100 text-gray-900", Default:"bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900"">
                    <svg class="w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div>
                <a href="{{ route('subscription.index') }}" class="flex items-center w-full py-2 pr-2 text-sm font-medium text-gray-900 rounded-md group pl-7" x-state:on="Current" x-state:off="Default" x-state-description="Current:"bg-gray-100 text-gray-900", Default:"bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900"">
                    <svg class="w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div x-data="{ open: false }" class="space-y-1">
                <button @click="open = !open" t type="button" class="flex items-center w-full py-2 pr-2 text-sm font-medium text-gray-900 rounded-md group pl-7" x-state:on="Current" x-state:off="Default" x-state-description="Current:"bg-gray-100 text-gray-900", Default:"bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900"">
                    ...
                    {{ ucwords(trans_choice('messages.analytics', 1)) }}
                ...
                <div x-description="Expandable link section, show/hide based on state." class="space-y-1" id="sub-menu-2" x-show="open" style="display: none;">
                    <a href="{{ url('/' . $page='analytics') }}" class="flex items-center w-full py-2 pl-16 pr-2 text-sm font-medium text-gray-600 rounded-md group hover:text-gray-900 hover:bg-gray-50">
                        {{ ucwords(trans_choice('messages.azure_analytic', 1)) }}
                    </a>
                    <a href="{{ url('/' . $page='analytics/licenses') }}" class="flex items-center w-full py-2 pl-16 pr-2 text-sm font-medium text-gray-600 rounded-md group hover:text-gray-900 hover:bg-gray-50">
