...
use Carbon\Carbon;
use App\Scopes\ExpirationScope;
use App\ExpirableEloquentQueryBuilder;
...
trait Expirable
{
    ...
    // {
    //     return defined('static::expiration_data') ? static::expiration_data : config('expirable.attribute_name', 'expiration_data');
    // }
