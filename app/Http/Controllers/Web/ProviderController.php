...
class ProviderController extends Controller
{
    ...
    // $average = 100-$average1;
        ...
        return view('provider.show', compact('provider', 'resellers', 'customers', 'instance', 'users','countries', 'subscriptions','order', 'statuses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $priceList = PriceList::create([
                ...
                ->with([
                    'alert' => 'danger', 
                    'message' => trans('messages.Pprovider_not_created') . " (" . trans($errorMessage) . ")."
                    ]);
                }
