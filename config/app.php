...
return [
    ...
    */
    ...
    'admin' => env('ADMIN_LEVEL'),
    'provider' => env('PROVIDER_LEVEL'),
    'reseller' => env('RESELLER_LEVEL'),
    'subreseller' => env('SUBRESELLER_LEVEL'),
    'customer' => env('CUSTOMER_LEVEL'),

    #ADMIN PERMISSIONS
    'manage_roles' => env('MANAGE_ROLES'),

    #PROVIDER PERMISSIONS
    'provider_index' => env('PROVIDER_INDEX'),
    'provider_show' => env('PROVIDER_SHOW'),
    'provider_create' => env('PROVIDER_CREATE'),
    'provider_edit' => env('PROVIDER_EDIT'),
    'provider_delete' => env('PROVIDER_DELETE'),

    #RESELLER PERMISSIONS
    'reseller_index' => env('RESELLER_INDEX'),
    'reseller_show' => env('RESELLER_SHOW'),
    'reseller_create' => env('RESELLER_CREATE'),
    'reseller_edit' => env('RESELLER_EDIT'),
    'reseller_delete' => env('RESELLER_DELETE'),

    #CUSTOMER PERMISSIONS
    'customer_index' => env('CUSTOMER_INDEX'),
    'customer_show' => env('CUSTOMER_SHOW'),
    'customer_create' => env('CUSTOMER_CREATE'),
    'customer_edit' => env('CUSTOMER_EDIT'),
    'customer_delete' => env('CUSTOMER_DELETE'),

    #PRICELIST PERMISSIONS
    'price_list_index' => env('PRICELIST_INDEX'),
    'price_list_show' => env('PRICELIST_SHOW'),
